...
Route::get('/user/logout',
    'Auth\LoginController@logout')->name('user.logout');

##startPage
Route::get('/user',
    'UserController@index')->name('user');

## 0.1  Service Forms
Route::get('/user/service/list',
    'UserController@showJournalRecords')->name('user.visits');
Route::get('/user/service/details/{visit_id?}',
    'UserController@showVisitFormsDetails')->name('user.service.details');
Route::get('/user/service/confirm/{visit_id?}',
    'UserController@confirmServiceReception')->name('user.service.confirm');

## 0.2  profile
Route::get('/user/profile/full',
    'UserController@showProfile')->name('user.profile');
Route::get('/user/profile/personal/edit/{group_name?}',
    'UserController@showEditProfileForm')->name('user.profile.personal.edit');
Route::post('/user/profile/personal/update',
    'UserController@updatePersonalDetails')->name('user.profile.personal.update');
Route::post('/user/profile/contact/p/update',
    'UserController@updatePrimaryContact')->name('user.profile.contact.primary.update');
Route::post('/user/profile/contact/e/add',
    'UserController@addEmergenceContact')->name('user.profile.contact.emergency.add');
Route::post('/user/profile/relative/add',
    'UserController@addBloodRelative')->name('user.profile.relative.add');


##0.3  MedicalBackground
Route::get('/user/info/background',
    'UserController@showMedicalBackground')->name('user.info.medical');

#VitalSigns (e.g weight)
Route::get('/user/info/trend/{vs_id?}/{viewMode?}',
    'UserController@showVitalSignTrend')->name('user.info.medical.vital_sign.trend');
Route::post('/user/info/trend/new',
    'UserController@saveNewVitalSignRecord')->name('user.info.medical.vital_sign.new');
Route::get('/user/info/trend/delete/{value_id?}',
    'UserController@deleteVitalSignRecord')->name('user.info.medical.weight.delete');

#MedicalConditions & Disease (e.g Asthma)
Route::get('/user/info/condition/new',
    'UserController@showAddNewConditionForm')->name('user.info.medical.condition.new');
Route::post('/user/info/condition/save',
    'UserController@saveNewMedicalCondition')->name('user.info.medical.condition.save');
...
Route::get('/health_provider/login/admin',
    'Auth\HealthProviderLoginController@showLoginForm')->name('health_provider.admin.login.form');
Route::post('/health_provider/login/admin',
    'Auth\HealthProviderLoginController@login')->name('health_provider.admin.login.login');
Route::get('/health_provider/register',
    'Auth\HealthProviderRegisterController@showRegistrationForm')->name('health_provider.registration.form');
Route::post('/health_provider/register',
    'Auth\HealthProviderRegisterController@register')->name('health_provider.registration.save');
Route::get('/health_provider/logout', '
Auth\HealthProviderLoginController@logout')->name('health_provider.admin.logout');

#HealthCare Admin Functions
Route::get('/health_provider/admin',
    'HealthCareProviderController@index')->name('health_provider.admin');

#profile
Route::get('/health_provider/profile',
    'HealthCareProviderController@showProfile')->name('health_provider.profile');

#staff | health Experts
Route::get('/health_provider/expert/{active_tab?}',
    'HealthCareProviderController@showEmployees')->name('health_provider.employees');
 Route::get('/health_provider/expert/add/{active_tab?}',
     'HealthCareProviderController@showAddEmployeeForm')->name('health_provider.employee.add.form');
Route::post('/health_provider/expert/save',
    'HealthCareProviderController@saveNewEmployee')->name('health_provider.employee.add.save');

Route::get('/health_provider/expert/edit/{active_tab?}/{expert_id?}',
    'HealthCareProviderController@showEditEmployeeForm')->name('health_provider.employee.edit.form');
Route::post('/health_provider/expert/update',
    'HealthCareProviderController@updateEmployee')->name('health_provider.employee.update');
 Route::get('/health_provider/expert/delete/{expert_id?}',
     'HealthCareProviderController@deleteEmployee')->name('health_provider.employee.delete');
