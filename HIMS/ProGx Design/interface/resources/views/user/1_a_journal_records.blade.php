                                                            ...
                                                            <div class="col-md-7 ">
                                                                <div class="visit-item bg-visit">
                                                                    ...
                                                                    <p>
                                                                        ...
                                                                        Serial Number
                                                                        <strong> XXXXCCCXXXXXXXXXX  </strong>
                                                                    </p>

                                                                    <p>
                                                                        <i class="fa fa-hospital"></i>
                                                                        Provider
                                                                        <strong> XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX </strong>
                                                                    </p>

                                                                    <p>
                                                                        <i class="fa fa-money-bill-alt"></i>
                                                                        Payment Mode
                                                                        <strong> XXXXXXXXXXXXXXXXXXXXXXXXXX </strong>
                                                                    </p>
                                                            ...
                                                            <div class="col-md-7 ">
                                                                <div class="visit-item bg-medication">
                                                                    ...
                                                                    <p>
                                                                        <i class="fa fa-pills"></i>
                                                                         Taken For
                                                                        <strong> XXXXXXXXXXXXXXXXXXXXXXXXXXXX  </strong>
                                                                    </p>

                                                                    <p>
                                                                        <i class="fa fa-calendar-day"></i>
                                                                        From <strong> XX-XX-XXXX  </strong>
                                                                        To  <strong> XX-XX-XXXX   </strong>
                                                                    </p>
