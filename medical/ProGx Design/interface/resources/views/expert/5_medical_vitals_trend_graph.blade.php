                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body" style=" background: #D1F2EB;">
                                                ...
                                                <div class="row current-visit" >
                                                    ...
                                                    <div class="col-12">
                                                        <h3>
                                                            <a class="btn btn-danger btn-sm float-right" href="{{ route('expert.user.medical.background') }}">
                                                        ...
                                                        <div>
                                                            <ul class="nav">
                                                                ...
                                                                <li class="nav-item {{ $viewMode =='records' ? ' active-form-nav':' ' }}">
                                                                    <a class="nav-link"
                                                                       href="{{ route('expert.user.medical.vital_sign.trend') }}/{{ $vitalSign->id }}/records">
                                                                ...
                                                                <li class="nav-item {{ $viewMode =='visualization' ? ' active-form-nav':' ' }}">
                                                                    <a class="nav-link"
                                                                       href="{{ route('expert.user.medical.vital_sign.trend') }}/{{ $vitalSign->id }}/visualization">
                                                                        View Trend Chart
